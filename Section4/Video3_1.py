...
from Designer_code.Video3_1_Design import Ui_MainWindow
...
class RunDesignerGUI():
    ...
    def widget_actions(self):
        ...
        #-------------------------------
        self.ui.pushButton_clear.clicked.connect(self.ui.label.clear)           # removed slot and placed code here (llose coupling)
