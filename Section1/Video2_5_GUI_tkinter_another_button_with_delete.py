...
def click_event():                                      # call back function
    ...
    #new_button = ttk.Button(gui, text="Delete me", command=lambda: new_button.pack_forget())    
    new_button = ttk.Button(gui, text="Delete me", command=lambda: new_button.destroy())    
    new_button.pack() 
