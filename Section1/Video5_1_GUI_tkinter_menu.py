...
def create_menu():
    ...
    help_menu = Menu(menu_bar, tearoff=False)               # parent=menu_bar
    help_menu.add_command(label="Help")                      # add menu item to menu
    
    menu_bar.add_cascade(menu=help_menu, label="Help")      # add menu to menu bar
    gui.config(menu=menu_bar)    
