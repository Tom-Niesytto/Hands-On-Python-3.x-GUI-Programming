...
def create_widgets():
    ...
    # make tab_one the parent instead of gui
    ...
    entry_one = ttk.Entry(tab_one, width=20, textvariable=entry_one_str)  #note that button was going onto gui and now it gowes onto Fram object                  
